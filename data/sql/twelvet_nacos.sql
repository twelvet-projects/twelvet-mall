DROP DATABASE IF EXISTS `twelvet_mall_nacos`;

CREATE DATABASE  `twelvet_mall_nacos` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

SET NAMES utf8;
SET FOREIGN_KEY_CHECKS = 0;

USE `twelvet_mall_nacos`;
...
INSERT INTO `config_info` VALUES (3, 'twelvet-server-system-dev.yml', 'DEFAULT_GROUP', 'spring: \n  datasource:\n    dynamic:\n      hikari:\n        # 连接测试查询\n        connection-test-query: SELECT 1 FROM DUAL\n        # 连接最大存活时间.不等于0且小于30秒，会被重置为默认值30分钟.设置应该比mysql设置的超时时间短\n        max-lifetime: 540000\n        # 只有空闲连接数大于最大连接数且空闲时间超过该值，才会被释放\n        idle-timeout: 500000\n        # 最小空闲连接，默认值10，小于0或大于maximum-pool-size，都会重置为maximum-pool-size\n        minimum-idle: 10\n        # 最大连接数，小于等于0会被重置为默认值10；大于零小于1会被重置为minimum-idle的值\n        maximum-pool-size: 12\n        # 连接超时时间:毫秒，小于250毫秒，否则被重置为默认值30秒\n        connection-timeout: 60000\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master \n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet_mall?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        shardingSphere:\n          driver-class-name: org.apache.shardingsphere.driver.ShardingSphereDriver\n          url: jdbc:shardingsphere:classpath:sharding-jdbc.yml\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n  data:\n    redis:\n      host: twelvet-redis\n      port: 6379\n      # 连接超时时间\n      timeout: 30s\n      lettuce:\n        pool:\n          # 连接池中的最小空闲连接\n          min-idle: 0\n          # 连接池中的最大空闲连接\n          max-idle: 8\n          # 连接池的最大数据库连接数\n          max-active: 8\n          # #连接池最大阻塞等待时间（使用负值表示没有限制）\n          max-wait: -1ms\n\nswagger:\n  title: TwelveT Swagger API\n  version: 2.7.0\n  description: 系统服务\n  license: Powered By TwelveT\n  licenseUrl: https://twelvet.cn\n  terms-of-service-url: https://twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://twelvet.cn\n  authorization:\n    name: password\n    token-url-list:\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token', 'eb796c6b97068a718c9341638e0f55ce', '2020-06-07 19:45:29', '2024-05-17 09:57:23', 'nacos', '0:0:0:0:0:0:0:1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '系统模块', 'null', 'null', 'yaml', 'null', '');
INSERT INTO `config_info` VALUES (4, 'twelvet-gateway-dev.yml', 'DEFAULT_GROUP', 'spring: \n  cloud:\n    gateway:\n      globalcors:\n        corsConfigurations:\n          \'[/**]\':\n            allowedOriginPatterns: \"*\"\n            allowed-methods: \"*\"\n            allowed-headers: \"*\"\n            allow-credentials: true\n            exposedHeaders: \"Content-Disposition,Content-Type,Cache-Control\"\n      loadbalancer: \n        use404: true\n      discovery:\n        locator:\n          # 开启服务名称小写匹配\n          lowerCaseServiceId: true\n          # 开启动态创建路由（不用每个都写死）\n          enabled: true\n      # 路由配置\n      routes:\n        # 认证中心\n        - id: twelvet-auth\n          uri: lb://twelvet-auth\n          predicates:\n            - Path=/auth/**\n          filters:\n            - StripPrefix=1\n        # 系统模块\n        - id: twelvet-server-system\n          # 匹配后提供服务的路由地址\n          uri: lb://twelvet-server-system\n           # 断言，路径匹配的进行路由\n          predicates:\n            - Path=/system/**\n          filters:\n            # 转发请求时去除路由前缀（system）\n            - StripPrefix=1\n            # 请求重写，将内部开放服务重写(重要配置，请勿轻易修改，否则将暴露用户信息API)\n            - RewritePath=/user/info(?<segment>/?.*), /from-user-info$\\{segment}\n        # 定时任务\n        - id: twelvet-server-job\n          uri: lb://twelvet-server-job\n          predicates:\n            - Path=/job/**\n          filters:\n            - StripPrefix=1\n        # DFS文件系统\n        - id: twelvet-server-dfs\n          uri: lb://twelvet-server-dfs\n          predicates:\n            - Path=/dfs/**\n          filters:\n            - StripPrefix=1\n            # 请求重写，不允许直接上传文件\n            - RewritePath=/upload(?<segment>/?.*), /from-upload$\\{segment}\n        # 代码生成器\n        - id: twelvet-server-gen\n          uri: lb://twelvet-server-gen\n          predicates:\n            - Path=/gen/**\n          filters:\n            - StripPrefix=1\n        # IM通讯\n        - id: twelvet-server-im\n          uri: lb://twelvet-server-im\n          predicates:\n            - Path=/im/**\n          filters:\n            - StripPrefix=1\n        # websocket\n        - id: twelvet-server-im\n          uri: lb://twelvet-server-web-socket\n          predicates:\n            - Path=/websocket/**\n          filters:\n            - StripPrefix=1\n        # 商品服务\n        - id: twelvet-server-goods\n          uri: lb://twelvet-server-goods\n          predicates:\n            - Path=/goods/**\n          filters:\n            - StripPrefix=1\n        # 直播服务\n        - id: twelvet-server-live\n          uri: lb://twelvet-server-live\n          predicates:\n            - Path=/live/**\n          filters:\n            - StripPrefix=1\n\n# 防止xss攻击\nsecurity:\n  xss:\n    enabled: true\n    excludeUrls: \n      ', 'ebbd044573f7a2fc2fe5e8dc7b2b4aa0', '2020-06-12 11:46:10', '2023-11-25 17:41:16', 'nacos', '127.0.0.1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '网关配置', 'null', 'null', 'yaml', 'null', '');
...
INSERT INTO `config_info` VALUES (7, 'twelvet-server-job-dev.yml', 'DEFAULT_GROUP', '# Spring\nspring: \n  datasource:\n    dynamic:\n      hikari:\n      # 连接测试查询\n      connection-test-query: SELECT 1 FROM DUAL\n      # 连接最大存活时间.不等于0且小于30秒，会被重置为默认值30分钟.设置应该比mysql设置的超时时间短\n      max-lifetime: 540000\n      # 只有空闲连接数大于最大连接数且空闲时间超过该值，才会被释放\n      idle-timeout: 500000\n      # 最小空闲连接，默认值10，小于0或大于maximum-pool-size，都会重置为maximum-pool-size\n      minimum-idle: 10\n      # 最大连接数，小于等于0会被重置为默认值10；大于零小于1会被重置为minimum-idle的值\n      maximum-pool-size: 12\n      # 连接超时时间:毫秒，小于250毫秒，否则被重置为默认值30秒\n      connection-timeout: 60000\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master\n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet_mall?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n  \nswagger:\n  title: TwelveT Swagger API\n  version: 2.7.0\n  description: 分布式调度服务\n  license: Powered By TwelveT\n  licenseUrl: https://twelvet.cn\n  terms-of-service-url: https://twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://twelvet.cn\n  authorization:\n    name: twelvet\n    auth-regex: ^.*$\n    authorization-scope-list:\n      - scope: server\n        description: server all\n    token-url-list:\n      - http://${GATEWAY_HOST:twelvet-gateway}:${GATEWAY_PORT:88}/auth/oauth/token\n# 开启Swagger增强模式\nknife4j:\n  enable: true', '12597189e8e77415180e3353d6f3e6f5', '2020-11-03 15:47:23', '2024-05-17 09:58:39', 'nacos', '0:0:0:0:0:0:0:1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (8, 'twelvet-server-dfs-dev.yml', 'DEFAULT_GROUP', 'spring: \n  datasource:\n   dynamic:\n    hikari:\n      # 连接测试查询\n      connection-test-query: SELECT 1 FROM DUAL\n      # 连接最大存活时间.不等于0且小于30秒，会被重置为默认值30分钟.设置应该比mysql设置的超时时间短\n      max-lifetime: 540000\n      # 只有空闲连接数大于最大连接数且空闲时间超过该值，才会被释放\n      idle-timeout: 500000\n      # 最小空闲连接，默认值10，小于0或大于maximum-pool-size，都会重置为maximum-pool-size\n      minimum-idle: 10\n      # 最大连接数，小于等于0会被重置为默认值10；大于零小于1会被重置为minimum-idle的值\n      maximum-pool-size: 12\n      # 连接超时时间:毫秒，小于250毫秒，否则被重置为默认值30秒\n      connection-timeout: 60000\n    # 设置默认的数据源或者数据源组,默认值即为master\n    primary: master\n    datasource:\n      # 主库数据源\n      master:\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        url: jdbc:mysql://twelvet-mysql:3306/twelvet_mall?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n        username: root\n        password: 123456\n      # 从库数据源\n      # slave:\n      # username:\n      # password:\n      # url:\n      # driver-class-name:\n    # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n    seata: false\n\n##qiniu账户信息配置##\noss:\n  qiniu:\n    ## key\n    accessKey: accessKey\n    # 秘钥\n    secretKey: secretKey\n    # 储存桶\n    bucketName: twelvet\n\nswagger:\n  title: TwelveT Swagger API\n  version: 2.7.0\n  description: DFS服务\n  license: Powered By TwelveT\n  licenseUrl: https://twelvet.cn\n  terms-of-service-url: https://twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://twelvet.cn\n  authorization:\n    name: password\n    token-url-list:\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token\n# 开启Swagger增强模式\nknife4j:\n  enable: true\n  ', 'f22bfa3879e169cdd6da2b946f2a4918', '2020-12-13 18:42:02', '2024-05-17 09:58:30', 'nacos', '0:0:0:0:0:0:0:1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '分布式文件系统', 'null', 'null', 'yaml', 'null', '');
...
INSERT INTO `config_info` VALUES (25, 'twelvet-server-gen-dev.yml', 'DEFAULT_GROUP', '# spring配置\nspring: \n  datasource:\n    dynamic:\n      hikari:\n        # 连接测试查询\n        connection-test-query: SELECT 1 FROM DUAL\n        # 连接最大存活时间.不等于0且小于30秒，会被重置为默认值30分钟.设置应该比mysql设置的超时时间短\n        max-lifetime: 540000\n        # 只有空闲连接数大于最大连接数且空闲时间超过该值，才会被释放\n        idle-timeout: 500000\n        # 最小空闲连接，默认值10，小于0或大于maximum-pool-size，都会重置为maximum-pool-size\n        minimum-idle: 10\n        # 最大连接数，小于等于0会被重置为默认值10；大于零小于1会被重置为minimum-idle的值\n        maximum-pool-size: 12\n        # 连接超时时间:毫秒，小于250毫秒，否则被重置为默认值30秒\n        connection-timeout: 60000\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master\n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet_mall?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n  data:\n    redis:\n      host: twelvet-redis\n      port: 6379\n      # 连接超时时间\n      timeout: 30s\n      lettuce:\n        pool:\n          # 连接池中的最小空闲连接\n          min-idle: 0\n          # 连接池中的最大空闲连接\n          max-idle: 8\n          # 连接池的最大数据库连接数\n          max-active: 8\n          # #连接池最大阻塞等待时间（使用负值表示没有限制）\n          max-wait: -1ms\n\n# 代码生成\ngen: \n  # 作者\n  author: TwelveT\n  # 默认生成包路径 system 需改成自己的模块名称 如 system monitor tool\n  packageName: com.twelvet.server.system\n  # 自动去除表前缀，默认是false\n  autoRemovePre: false\n  # 表前缀（生成类名不会包含表前缀，多个用逗号分隔）\n  tablePrefix: sys_\n\nswagger:\n  title: TwelveT Swagger API\n  version: 2.7.0\n  description: CRUD服务\n  license: Powered By TwelveT\n  licenseUrl: https://twelvet.cn\n  terms-of-service-url: https://twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://twelvet.cn\n  authorization:\n    name: password\n    token-url-list:\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token\n# 开启Swagger增强模式\nknife4j:\n  enable: true', '983e2542796f858819b9d243b63828af', '2021-03-20 13:04:24', '2024-05-17 09:58:18', 'nacos', '0:0:0:0:0:0:0:1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '代码生成器', 'null', 'null', 'yaml', 'null', '');
INSERT INTO `config_info` VALUES (491, 'twelvet-server-im-dev.yml', 'DEFAULT_GROUP', 'spring: \n  datasource:\n    dynamic:\n      hikari:\n        # 连接测试查询\n        connection-test-query: SELECT 1 FROM DUAL\n        # 连接最大存活时间.不等于0且小于30秒，会被重置为默认值30分钟.设置应该比mysql设置的超时时间短\n        max-lifetime: 540000\n        # 只有空闲连接数大于最大连接数且空闲时间超过该值，才会被释放\n        idle-timeout: 500000\n        # 最小空闲连接，默认值10，小于0或大于maximum-pool-size，都会重置为maximum-pool-size\n        minimum-idle: 10\n        # 最大连接数，小于等于0会被重置为默认值10；大于零小于1会被重置为minimum-idle的值\n        maximum-pool-size: 12\n        # 连接超时时间:毫秒，小于250毫秒，否则被重置为默认值30秒\n        connection-timeout: 60000\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master \n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet_mall_im?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n  data:\n    redis:\n      host: twelvet-redis\n      port: 6379\n      # 连接超时时间\n      timeout: 30s\n      lettuce:\n        pool:\n          # 连接池中的最小空闲连接\n          min-idle: 0\n          # 连接池中的最大空闲连接\n          max-idle: 8\n          # 连接池的最大数据库连接数\n          max-active: 8\n          # #连接池最大阻塞等待时间（使用负值表示没有限制）\n          max-wait: -1ms\n\nswagger:\n  title: TwelveT Swagger API\n  version: 2.7.0\n  description: 系统服务\n  license: Powered By TwelveT\n  licenseUrl: https://twelvet.cn\n  terms-of-service-url: https://twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://twelvet.cn\n  authorization:\n    name: password\n    token-url-list:\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token', '2bc12edd1c78df90a7ff974dd5955c87', '2023-07-15 09:10:13', '2024-05-17 09:58:09', 'nacos', '0:0:0:0:0:0:0:1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (492, 'twelvet-server-goods-dev.yml', 'DEFAULT_GROUP', 'spring: \n  datasource:\n    dynamic:\n      hikari:\n        # 连接测试查询\n        connection-test-query: SELECT 1 FROM DUAL\n        # 连接最大存活时间.不等于0且小于30秒，会被重置为默认值30分钟.设置应该比mysql设置的超时时间短\n        max-lifetime: 540000\n        # 只有空闲连接数大于最大连接数且空闲时间超过该值，才会被释放\n        idle-timeout: 500000\n        # 最小空闲连接，默认值10，小于0或大于maximum-pool-size，都会重置为maximum-pool-size\n        minimum-idle: 10\n        # 最大连接数，小于等于0会被重置为默认值10；大于零小于1会被重置为minimum-idle的值\n        maximum-pool-size: 12\n        # 连接超时时间:毫秒，小于250毫秒，否则被重置为默认值30秒\n        connection-timeout: 60000\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master \n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet_mall_goods?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n  data:\n    redis:\n      host: twelvet-redis\n      port: 6379\n      # 连接超时时间\n      timeout: 30s\n      lettuce:\n        pool:\n          # 连接池中的最小空闲连接\n          min-idle: 0\n          # 连接池中的最大空闲连接\n          max-idle: 8\n          # 连接池的最大数据库连接数\n          max-active: 8\n          # #连接池最大阻塞等待时间（使用负值表示没有限制）\n          max-wait: -1ms\n\nswagger:\n  title: TwelveT Swagger API\n  version: 2.7.0\n  description: 系统服务\n  license: Powered By TwelveT\n  licenseUrl: https://twelvet.cn\n  terms-of-service-url: https://twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://twelvet.cn\n  authorization:\n    name: password\n    token-url-list:\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token', 'e531871dc54dfff958bb4820468ba425', '2023-07-15 09:10:36', '2024-05-17 09:57:57', 'nacos', '0:0:0:0:0:0:0:1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '', '', '', 'yaml', '', '');
INSERT INTO `config_info` VALUES (496, 'twelvet-server-live-dev.yml', 'DEFAULT_GROUP', 'spring: \n  datasource:\n    dynamic:\n      hikari:\n        # 连接测试查询\n        connection-test-query: SELECT 1 FROM DUAL\n        # 连接最大存活时间.不等于0且小于30秒，会被重置为默认值30分钟.设置应该比mysql设置的超时时间短\n        max-lifetime: 540000\n        # 只有空闲连接数大于最大连接数且空闲时间超过该值，才会被释放\n        idle-timeout: 500000\n        # 最小空闲连接，默认值10，小于0或大于maximum-pool-size，都会重置为maximum-pool-size\n        minimum-idle: 10\n        # 最大连接数，小于等于0会被重置为默认值10；大于零小于1会被重置为minimum-idle的值\n        maximum-pool-size: 12\n        # 连接超时时间:毫秒，小于250毫秒，否则被重置为默认值30秒\n        connection-timeout: 60000\n      # 设置默认的数据源或者数据源组,默认值即为master\n      primary: master \n      datasource:\n        # 主库数据源\n        master:\n          driver-class-name: com.mysql.cj.jdbc.Driver\n          url: jdbc:mysql://twelvet-mysql:3306/twelvet_mall?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8\n          username: root\n          password: 123456\n        # 从库数据源\n        # slave:\n        # username:\n        # password:\n        # url:\n        # driver-class-name:\n      # 开启seata代理，开启后默认每个数据源都代理,分布式事务必须开启,否则关闭\n      seata: false\n  data:\n    redis:\n      host: twelvet-redis\n      port: 6379\n      # 连接超时时间\n      timeout: 30s\n      lettuce:\n        pool:\n          # 连接池中的最小空闲连接\n          min-idle: 0\n          # 连接池中的最大空闲连接\n          max-idle: 8\n          # 连接池的最大数据库连接数\n          max-active: 8\n          # #连接池最大阻塞等待时间（使用负值表示没有限制）\n          max-wait: -1ms\n\nswagger:\n  title: TwelveT Swagger API\n  version: 2.7.0\n  description: 系统服务\n  license: Powered By TwelveT\n  licenseUrl: https://twelvet.cn\n  terms-of-service-url: https://twelvet.cn\n  contact:\n    name: TwelveT\n    email: 2471835953@qq.com\n    url: https://twelvet.cn\n  authorization:\n    name: password\n    token-url-list:\n      - http://${GATEWAY_HOST:localhost}:${GATEWAY_PORT:88}/auth/oauth/token', '8770b15201448e10c50a5aa73cfd2558', '2023-08-17 17:56:44', '2024-05-17 09:57:43', 'nacos', '0:0:0:0:0:0:0:1', '', 'eeb43899-8a88-4f5b-b0e0-d7c8fd09b86e', '', '', '', 'yaml', '', '');
